      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Kod +998****${widget.phoneNumber.substring(
                  13)} raqamiga jo’natildi",
            ...
            const Spacer(),
            ButtonItem(text: "Keyingisi", onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_)=> const ResentPassword()));
            }),
            const SizedBox(
              height: 43,
            )
